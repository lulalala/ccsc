  ...
  def create
    ...
    respond_to do |format|
      if @admin_fountain.save
        format.html { redirect_to edit_admin_fountain_path(@admin_fountain), notice: 'Fountain was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @admin_fountain.update(admin_fountain_params)
        format.html { redirect_to edit_admin_fountain_path(@admin_fountain), notice: 'Fountain was successfully updated.' }
      else
